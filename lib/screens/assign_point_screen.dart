import 'package:blind_artist_game/models/player.dart';
...
class AssignPointScreen extends StatelessWidget {
  ...
  void _showAnimatedOverlay(
      BuildContext context, Player player, int delta) async {
    // Анимация +1 / -1
  ...
  Widget build(BuildContext context) {
    ...
    final otherPlayers =
        gameService.players.where((p) => p != currentPlayer).toList();
